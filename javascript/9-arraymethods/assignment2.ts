...
let games: IGame[] = [ { id: 1586948654, date: "2022-10-27", score: 145, won: false },
...
//A)
console.log('A)', games.find((value) => value.id === 1958468135))
//B)
console.log('B)', games.findIndex((value )=> value.won === true))
